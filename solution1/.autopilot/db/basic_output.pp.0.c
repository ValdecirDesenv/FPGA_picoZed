# 1 "FPGA_picoZed/basic_output.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 339 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/vdc/vivado/Vitis_HLS/2023.1/common/technology/autopilot/etc/autopilot_ssdm_op.h" 1
# 269 "/home/vdc/vivado/Vitis_HLS/2023.1/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
# 2 "<built-in>" 2
# 1 "FPGA_picoZed/basic_output.c" 2
__attribute__((sdx_kernel("basic_output", 0))) void basic_output(unsigned char *o){
#line 16 "/home/vdc/dev/FPGA/FPGA_picoZed/solution1/csynth.tcl"
